...
class UI {
    ...
    showScores(score) {
        ...
        font-size: 15px;">
            <a style="margin-right: 30px;" href="../index.html">Mi Historia</a>
            <a style="margin-right: 30px;" href="../proyects.html">Proyectos</a>
            <a style="margin-right: 30px;" href="../Hobbies.html">Hobbies</a>
        </div> 
        <div style="text-align: center;"><h1>Resultados</h1>
